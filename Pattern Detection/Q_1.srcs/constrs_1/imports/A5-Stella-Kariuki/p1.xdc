...
# User LEDs - Bank 33
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN T22 [get_ports {count[0]}];  # "LD0" --> count(0)
set_property PACKAGE_PIN T21 [get_ports {count[1]}];  # "LD1" --> count(1)
set_property PACKAGE_PIN U22 [get_ports {count[2]}];  # "LD2" --> count(2)
set_property PACKAGE_PIN U21 [get_ports {count[3]}];  # "LD3" --> count(3)
set_property PACKAGE_PIN V22 [get_ports {count[4]}];  # "LD4" --> count(4)
set_property PACKAGE_PIN W22 [get_ports {count[5]}];  # "LD5" --> count(5)
set_property PACKAGE_PIN U19 [get_ports {count[6]}];  # "LD6" --> count(6)
set_property PACKAGE_PIN U14 [get_ports {count[7]}];  # "LD7" --> count(7)
...
#set_property PACKAGE_PIN R16 [get_ports {end_in}];  # "BTND" --> end_in
#set_property PACKAGE_PIN N15 [get_ports {din}];  # "BTNL" --> din
...
## ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN F22 [get_ports {din_valid}];  # "SW0" --> din_valid
set_property PACKAGE_PIN G22 [get_ports {din}];  # "SW1"  --> din
#set_property PACKAGE_PIN H22 [get_ports {count[2]}];  # "SW2"
#set_property PACKAGE_PIN F21 [get_ports {count[3]}];  # "SW3"
#set_property PACKAGE_PIN H19 [get_ports {count[4]}];  # "SW4"
#set_property PACKAGE_PIN H18 [get_ports {count[5]}];  # "SW5"
#set_property PACKAGE_PIN H17 [get_ports {count[6]}];  # "SW6"
set_property PACKAGE_PIN M15 [get_ports {done}];  # "SW7" --> done
