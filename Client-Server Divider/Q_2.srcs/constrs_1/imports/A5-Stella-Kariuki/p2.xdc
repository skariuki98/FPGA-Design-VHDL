...
# ---------------------------------------------------------------------------- 
#set_property PACKAGE_PIN Y9 [get_ports {GCLK}];  # "GCLK" #original definition
#
...
set_property PACKAGE_PIN Y13  [get_ports {result[0]}];  # "HD-D0" --> result[0]
set_property PACKAGE_PIN AA13 [get_ports {result[1]}];  # "HD-D1" --> result[1]   
#set_property PACKAGE_PIN W13  [get_ports {r[2]}];  # "HD-D10" 
#set_property PACKAGE_PIN W15  [get_ports {r[3]}];  # "HD-D11"
#set_property PACKAGE_PIN V15  [get_ports {r[4]}];  # "HD-D12"
#set_property PACKAGE_PIN U17  [get_ports {r[5]}];  # "HD-D13"
#set_property PACKAGE_PIN V14  [get_ports {r[6]}];  # "HD-D14"
#set_property PACKAGE_PIN V13  [get_ports {r[7]}];  # "HD-D15"
set_property PACKAGE_PIN AA14 [get_ports {result[2]}];  # "HD-D2" --> result[2]
set_property PACKAGE_PIN Y14  [get_ports {result[3]}];  # "HD-D3" --> result[3]
set_property PACKAGE_PIN AB15 [get_ports {result[4]}];  # "HD-D4" --> result[4]
set_property PACKAGE_PIN AB16 [get_ports {result[5]}];  # "HD-D5" --> result[5]
set_property PACKAGE_PIN AA16 [get_ports {result[6]}];  # "HD-D6" --> result[6]
set_property PACKAGE_PIN AB17 [get_ports {result[7]}];  # "HD-D7" --> result[7]
#set_property PACKAGE_PIN AA17 [get_ports {r[0]}];  # "HD-D8"
#set_property PACKAGE_PIN Y15  [get_ports {r[1]}];  # "HD-D9"
...
# User LEDs - Bank 33
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN T22 [get_ports {done}];  # "LD0" --> done
set_property PACKAGE_PIN T21 [get_ports {ready}];  # "LD1" --> ready
set_property PACKAGE_PIN U22 [get_ports {error}];  # "LD2" --> error
...
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN P16 [get_ports {reset}];  # "BTNC" --> reset
set_property PACKAGE_PIN R16 [get_ports {data_valid}];  # "BTND" --> data_valid
set_property PACKAGE_PIN N15 [get_ports {ack}];  # "BTNL" --> ack
#set_property PACKAGE_PIN R18 [get_ports {BTNR}];  # "BTNR"
#set_property PACKAGE_PIN T18 [get_ports {start_in}];  # "BTNU". --> start_in
...
## ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN F22 [get_ports {data[0]}];  # "SW0" --> data(0)
set_property PACKAGE_PIN G22 [get_ports {data[1]}];  # "SW1" --> data(1)
set_property PACKAGE_PIN H22 [get_ports {data[2]}];  # "SW2" --> data(2)
set_property PACKAGE_PIN F21 [get_ports {data[3]}];  # "SW3" --> data(3)
set_property PACKAGE_PIN H19 [get_ports {data[4]}];  # "SW4" --> data(4)
set_property PACKAGE_PIN H18 [get_ports {data[5]}];  # "SW5" --> data(5)
set_property PACKAGE_PIN H17 [get_ports {data[6]}];  # "SW6" --> data(6)
set_property PACKAGE_PIN M15 [get_ports {data[7]}];  # "SW7" --> data(7)
