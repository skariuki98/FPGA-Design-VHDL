...
HD_PWD='C:/Users/kariu/Documents/Spring 2022/CDA4253 FPGA/Projects/A5-Stella-Kariuki/Q_2/Q_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log server.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source server.tcl -notrace
